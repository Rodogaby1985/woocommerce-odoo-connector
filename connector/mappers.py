...
class ProductMapper:
    ...
    def wc_to_odoo(product: dict[str, Any]) -> dict[str, Any]:
        ...
        mapped = {
            ...
            "x_sale_price": _to_float(product.get("sale_price")) if product.get("sale_price") else 0.0,
            "x_sale_date_from": product.get("date_on_sale_from") or False,
            "x_sale_date_to": product.get("date_on_sale_to") or False,
    ...
    def odoo_to_wc(product: dict[str, Any]) -> dict[str, Any]:
        ...
        mapped = {
            ...
            "sale_price": str(_to_float(product.get("x_sale_price"))) if product.get("x_sale_price") else "",
            "date_on_sale_from": product.get("x_sale_date_from") or "",
            "date_on_sale_to": product.get("x_sale_date_to") or "",
...
class VariantMapper:
    ...
    def wc_variation_to_odoo(wc_variation: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "x_sale_price": _to_float(wc_variation.get("sale_price")) if wc_variation.get("sale_price") else 0.0,
            "x_sale_date_from": wc_variation.get("date_on_sale_from") or False,
            "x_sale_date_to": wc_variation.get("date_on_sale_to") or False,
    ...
    def odoo_variant_to_wc_variation(odoo_variant: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "sale_price": str(_to_float(odoo_variant.get("x_sale_price"))) if odoo_variant.get("x_sale_price") else "",
            "date_on_sale_from": odoo_variant.get("x_sale_date_from") or "",
            "date_on_sale_to": odoo_variant.get("x_sale_date_to") or "",
